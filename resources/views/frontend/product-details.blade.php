                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="product-details-content">
                                    ...
                                    <div class="product-details-select-items-wrap">
                                        @foreach ($product->size as $ssize)
                                            <div class="product-details-select-item-outer">
                                                <input type="radio" name="size" value="{{ $ssize->name }}"
                                                    class="category-item-radio">
                                                <label for="size"
                                                    class="category-item-label">{{ $ssize->name }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                        ...
                        <div class="product-details-info">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-policy" role="tabpanel"
                                    ...
                                    ut unde laudantium accusamus odio nam officia aperiam excepturi quis nesciunt eveniet
                                    eligendi
                                </div>
                            </div>
                        </div>
